...
public final class SwerveConstants {
    ...
    public static final class DriveConstants {
        ...
        public static final double kTeleDriveMaxSpeedMetersPerSecond = VelocityConstants.Velocities.kTeleDriveMaxSpeedMetersPerSecond;
        public static final double kTeleDriveMaxAngularSpeedRadiansPerSecond = VelocityConstants.Velocities.kTeleDriveMaxAngularSpeedRadiansPerSecond;
        public static final double kTeleDriveMaxAccelerationUnitsPerSecond = VelocityConstants.Velocities.kTeleDriveMaxAccelerationUnitsPerSecond;
        public static final double kTeleDriveMaxAngularAccelerationUnitsPerSecond = VelocityConstants.Velocities.kTeleDriveMaxAngularAccelerationUnitsPerSecond;
    }
    ...
    public static final class AutoConstants {
        ...
        public static final double translationController = 2.5;
