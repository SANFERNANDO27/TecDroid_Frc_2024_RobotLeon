...
public class StartShoot extends Command {
    ...
    public StartShoot(Indexer indexer, Intake intake, Shooter shooter, 
    ...
    public void execute() {
        ...
        shooterPositioner.goToPosition(39.0);
        

        // Align to Apriltag
        swerveAlignToAprilTag.RotateAtAprilTagDetectionSetPoint(0);

        if (shooter.isAtSetPoint(ShooterConstants.shootVelocity) && shooterPositioner.isAtSetPoint(39.0)) {
            // Intake
